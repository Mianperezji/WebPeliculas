...
function showMovies(movieid, page){
    const url = `https://api.themoviedb.org/3/tv/${movieid}/similar?api_key=18ef69cc57d3bb121a044122e1e6ecf4&language=${localStorage.getItem("idioma")}&page=${page}`
    ...
    data.results.forEach(element => {
      ...
      video.href="https://www.youtube.com/results?search_query="+element.name;
